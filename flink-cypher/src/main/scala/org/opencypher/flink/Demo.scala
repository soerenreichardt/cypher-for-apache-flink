...
object Demo extends App {
  ...
  graph.cypher("MATCH (n:Person)-[r:KNOWS]->(n2:Person) RETURN n.name, n2.name").getRecords.show
//  graph.cypher("MATCH (n:Person)-[r:KNOWS*1..2]->(n2:Person) RETURN n, n2").getRecords.show
