...
object CAPFSchema {
  val empty: CAPFSchema = PropertyGraphSchema.empty.asCapf

  implicit class CAPFSchemaConverter(schema: PropertyGraphSchema) {
...
case class CAPFSchema private[schema](schema: PropertyGraphSchema) extends PropertyGraphSchema {
