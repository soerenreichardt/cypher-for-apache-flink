...
trait TeamDataFixture extends TestDataFixture {
  ...
  lazy val knowsTable = CAPFElementTable.create(knowsMapping, knowsDF)
  ...
  lazy val programmerTable = CAPFElementTable.create(programmerMapping, programmerDF)
  ...
  lazy val brogrammerTable = CAPFElementTable.create(brogrammerMapping, brogrammerDF)
  ...
  lazy val  bookTable = CAPFElementTable.create(bookMapping, bookDF)
  ...
  lazy val readsTable = CAPFElementTable.create(readsMapping, readsDF)
  ...
  lazy val influencesTable = CAPFElementTable.create(influencesMapping, influencesDF)
